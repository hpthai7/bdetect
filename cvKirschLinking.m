function O = cvKirschLinking(I, gthresh, amplink, anglink)
% Description
%		Linking edges detected by Kirsch kernel
%
% Synopsis
%		O = cvKirschLinking(I, gthresh, amplink, anglink)
%
...
%		O = cvKirschLinking(I, [], [], []);
%		figure; imshow(O);
%		O = cvKirschLinking(I, 40, 30, pi);
%		figure; imshow(O);
%
% Requirements
%		cvKirsch (requires conv2)
%
% Authors
%		Thai Ho
%
