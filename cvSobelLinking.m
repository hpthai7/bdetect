function O = cvSobelLinking(I, gthresh, amplink, anglink)
% Description
%		Linking edges detected by Sobel operator
%
% Synopsis
%		O = cvSobelLinking(I, gthresh, amplink, anglink)
%
