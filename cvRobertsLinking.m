function O = cvRobertsLinking(I, gthresh, amplink, anglink)
% Description
%		Linking edges detected by Roberts operator
%
% Synopsis
%		O = cvRobertsLinking(I, gthresh, amplink, anglink)
%
...
%		O = cvRobertsLinking(I, [], [], []);
%		figure; imshow(O);
%		O = cvRobertsLinking(I, 40, 30, pi/3);
%		figure; imshow(O);
%
% Requirements
